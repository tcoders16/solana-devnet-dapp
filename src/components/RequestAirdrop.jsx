...
export function RequestAirdrop() {
  ...
  return (
    <div className="mt-20 px-4 w-full max-w-4xl mx-auto">
      <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 text-center tracking-wider drop-shadow-[0_0_10px_#3b82f6]">
        Request Airdrop
      </h2>

      {/* Learning Box */}
      <div className="bg-[#0f0f0f] border border-blue-500 text-blue-300 p-6 mb-10 rounded-lg shadow-[0_0_15px_#3b82f6] font-mono text-sm sm:text-base">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center items-center gap-4">
        <input
          ...
          className="bg-black border border-blue-500 text-white px-4 py-2 rounded-lg w-full sm:w-64 text-center shadow-[0_0_15px_#3b82f6] focus:outline-none focus:ring-2 focus:ring-blue-600"
        />

        <button
          onClick={requestAirdrop}
          disabled={loading}
          className="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-2 rounded-lg transition duration-300 shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto"
        >
      ...
      {message && (
        <div
          className={`mt-6 text-sm px-4 py-2 rounded-lg w-full max-w-xl mx-auto text-center font-mono ${
            message.startsWith("✅")
